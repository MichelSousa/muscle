...
$metaboxes = array(
	'video_url' => array(
		'title' => __('URL do Vídeo:', 'anaforti'),
		'applicableto' => 'post',
		'location' => 'normal',
	...
	'author_quote' => array(
		'title' => __('Citação:', 'anaforti'),
		'applicableto' => 'colaboradoras',
		'location' => 'normal',
		'priority' => 'low',
		'fields' => array(
			'author_quote' => array(
				'title' => __('Citação da Colaboradora: ', 'anaforti'),
				'type' => 'text',
				'description' => '',
				)
			)
...
/* Uncomment for display the metaboxes */
